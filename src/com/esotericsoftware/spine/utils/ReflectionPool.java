...
import com.esotericsoftware.spine.utils.reflect.ClassReflection;
import com.esotericsoftware.spine.utils.reflect.Constructor;
import com.esotericsoftware.spine.utils.reflect.ReflectionException;
...
public class ReflectionPool<T> extends Pool<T> {
	...
	protected T newObject () {
		try {
			...
			System.err.println("Unable to create new instance: " + constructor.getDeclaringClass().getName());
			ex.printStackTrace();
			return null;
		}
	}
